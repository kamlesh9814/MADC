...
import 'package:flutter_sixvalley_ecommerce/data/model/response/special_category_model.dart';
...
class SpecialCategoryProductWidget extends StatelessWidget {
  final SellerProduct productModel;
  const SpecialCategoryProductWidget({Key? key, required this.productModel})
      : super(key: key);
            ...
            Padding(
              ...
              child: Center(
                child: Column(
                  ...
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    if (productModel.currentStock! < productModel.minQty &&
                        productModel.productType == ProductTypeEnum.PHYSICAL)
                      Padding(
                          padding: const EdgeInsets.only(
                              bottom: Dimensions.paddingSizeExtraSmall),
                          child: Text(
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      Text('(${productModel.reviewsCount.toString()})',
                          style: textRegular.copyWith(
                              fontSize: Dimensions.fontSizeSmall,
                              color: Theme.of(context).hintColor)),
                    ]),
                    ...
                    Text(
                        PriceConverter.convertPrice(context,
                            ...
                            discountType: productModel.discountType.name,
                            discount:
                    ...
                    child: Center(
                      child: Text(
                          PriceConverter.percentageCalculation(
                              ...
                              double.parse(productModel.unitPrice.toString()),
                              double.parse(productModel.discount.toString()),
                              productModel.discountType.name),
                          style: textRegular.copyWith(
                              color: Theme.of(context).highlightColor,
                              fontSize: Dimensions.fontSizeSmall)),
                    ),
