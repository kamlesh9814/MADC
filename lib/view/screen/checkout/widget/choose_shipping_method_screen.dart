...
class ChooseShippingMethodScreen extends StatelessWidget {
  final bool onlyDigital;

  const ChooseShippingMethodScreen({Key? key, required this.onlyDigital})
      : super(key: key);
                                                    ...
                                                    builder: (context) =>
                                                        ShippingMethodBottomSheet(
                                                            groupId: sellerGroupList[index]
                                                                .cartGroupId,
                                                            sellerIndex: index,
                                                            sellerId: sellerGroupList[index]
                                                                .id),
                                                  );
                                                },
                                                child:
