...
class ProductProvider extends ChangeNotifier {
  ...
  SpecialCategoryProduct? specialCategoryProductModel;

  /// specialCategoryProducts
  ///
  Future<void> getSpecialCategoryProducts({required categoryID}) async {
    _isLoading = true;
    notifyListeners();
    try {
      ApiResponse apiResponse =
          await productRepo!.getSpecialCategoryProducts(categoryID);
      specialCategoryProductModel =
          SpecialCategoryProduct.fromJson(apiResponse.response?.data);
      _isLoading = false;
      notifyListeners();
    } catch (e) {
      _isLoading = false;
